...
function ResetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:8080'}/auth/change-password`, {
        method: 'POST',
        ...
        <div className="w-full max-w-md">
          <div className="card animate-fade-up">
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="font-display text-3xl text-wsu-navy mb-1">Reset Password</h1>
              <p className="text-wsu-slate text-sm">Enter your new password below</p>
            </div>
