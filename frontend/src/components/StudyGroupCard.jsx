function StudyGroupCard({ group, joined, joinLoading, onJoin, onLeave, onViewDetails }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-5 hover:shadow-xl transition-all duration-300 hover:scale-[1.01] flex flex-col gap-3 border border-transparent dark:border-gray-700">
      ...
      {/* Name + course */}
      <div>
        <h3 className="font-display text-lg text-wsu-navy dark:text-white mb-0.5">{group.name}</h3>
